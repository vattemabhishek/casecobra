...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === 'development'
      ? 'http://localhost:3000'
      : 'https://casecobra-eosin.vercel.app'
  return (
    <Html>
      <Head />
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We're preparing everything for delivery adn will notify you once
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any questions. (Please do not
                reply, automated email)
              </Text>
            </Row>
            <Row>
